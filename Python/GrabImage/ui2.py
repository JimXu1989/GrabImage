...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.timer = QTimer()
        self.timer.timeout.connect(self.update_real_time_label)
        self.timer.start(50)
    ...
    def get_real_time_img(self):
        ...
        stFloatValue = c_float(0.0)
        ret2 = self.cam.MV_CC_GetFloatValue('ExposureTime',stFloatValue)
        if ret != 0:
    ...
    def update_real_time_label(self):
        self.pixmap = QtGui.QPixmap.fromImage(self.QImg2)
        self.real_time_img_win.setPixmap(self.pixmap)
