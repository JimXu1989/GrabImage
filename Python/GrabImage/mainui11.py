...
class Ui_MainWindow(object):
    ...
    def showManualUI(self):
        ...
        self.manualui.sendButton.clicked.connect(self.manual_confirm_result)
    ...
    def confirm_result(self):
        ...
        if (self.feedbackResponse == 'feed back result got'):
            self.label_3.text('确认成功')

    def manual_confirm_result(self):
